      ...
      <div className="footer-container">
        ...
        <div className="footer-grid">
          ...
          <div className="footer-brand">
            ...
            <p className="brand-description">
              La plataforma que conecta lectores de todo Argentina. 
              Compra, vende y descubre tu próximo libro favorito en nuestra 
          ...
          <div className="footer-section">
            ...
            <div className="footer-links">
              ...
              <Link to="/comprar?genero=Misterio">Misterio</Link>
              <Link to="/comprar?genero=Novela">Novela</Link>
            </div>
          </div>
          ...
          <div className="footer-section">
            ...
            <div className="footer-links">
              ...
              <Link to="#" onClick={(e) => { e.preventDefault(); window.location.href = 'mailto:itsbookloop@gmail.com'; }}>Contacto</Link>
        ...
        <div className="footer-newsletter">
          <div className="newsletter-content">
            ...
            <p>Recibe notificaciones de nuevos libros y ofertas especiales</p>
        ...
        <div className="footer-bottom">
          <div className="footer-bottom-content">
            <div className="copyright">
              ...
              <p>Conectando lectores en Argentina desde Tucumán 🇦🇷</p>
            </div>
            <div className="footer-contact">
              <span>📞 (+54) 381-569-9499</span>
              <span>✉️ itsbookloop@gmail.com</span>
